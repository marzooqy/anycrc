...
__declspec(dllexport) word_t crc_bitwise(model_t *model, word_t crc, void const *dat, size_t len);
...
__declspec(dllexport) void crc_table_bytewise(model_t *model);
...
__declspec(dllexport) word_t crc_bytewise(model_t *model, word_t crc, void const *dat, size_t len);
...
__declspec(dllexport) void crc_table_slice16(model_t *model);
...
__declspec(dllexport) word_t crc_slice16(model_t *model, word_t crc, void const *dat, size_t len);
...
__declspec(dllexport) void crc_table_combine(model_t *model);
...
__declspec(dllexport) word_t crc_combine(model_t *model, word_t crc1, word_t crc2, uintmax_t len2);
