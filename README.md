...
If [bitarray](https://github.com/ilanschnell/bitarray) is installed, then the length of the data can be specified in bits by calling `calc_bits` and passing a bitarray object:
...
| Module | Speed |
|---|---|
| fastcrc (SSE) | 30.04 GiB/s |
| **anycrc** | **21.16 GiB/s** |
| crcmod-plus | 623.84 MiB/s |
| libscrc | 141.14 MiB/s |
| crcengine | 6.48 MiB/s |
| pycrc | 5.71 MiB/s |
| crccheck | 0.95 MiB/s |
| crc | 0.31 MiB/s |
